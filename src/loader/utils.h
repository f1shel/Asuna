...
inline nvmath::mat4f Json2Mat4(const nlohmann::json& json)
{
  ...
  return nvmath::mat4f(json[0], json[4], json[8], json[12], json[1], json[5], json[9], json[13], json[2], json[6],
                       json[10], json[14], json[3], json[7], json[11], json[15]);
}
...
inline nvmath::mat3f Json2Mat3(const nlohmann::json& json)
{
  ...
  return nvmath::mat3f(json[0], json[3], json[6], json[1], json[4], json[7], json[2], json[5], json[8]);
}
